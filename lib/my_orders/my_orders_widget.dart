...
class _MyOrdersWidgetState extends State<MyOrdersWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      future: BackendAPIGroup.alluserOrdersCall.call(
      ...
      builder: (context, snapshot) {
        ...
        final myOrdersAlluserOrdersResponse = snapshot.data!;
                        ...
                        child: Builder(
                          builder: (context) {
                            final ordersBody = BackendAPIGroup.alluserOrdersCall
                                    .ordersBody(
                                      myOrdersAlluserOrdersResponse.jsonBody,
                                    )
                                    ?.toList() ??
                                [];
