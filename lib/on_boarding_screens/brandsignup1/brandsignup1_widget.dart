...
import 'brandsignup1_model.dart';
export 'brandsignup1_model.dart';
import 'dart:convert'; // <-- Added for JSON encoding/decoding
import 'package:http/http.dart' as http; // <-- Added for making HTTP requests

class Brandsignup1Widget extends StatefulWidget {
  const Brandsignup1Widget({super.key});

  @override
  State<Brandsignup1Widget> createState() => _Brandsignup1WidgetState();
}

class _Brandsignup1WidgetState extends State<Brandsignup1Widget> {
  late Brandsignup1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Brandsignup1Model());
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      validator: _model.conpassTextControllerValidator
                          .asValidator(context),
                    ),
                  ),
                  Padding(
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (value) async {
                        if (value.length == 6) {
                          final cityStateMap = await _fetchCityAndState(value);
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: 'Describe Your Brand shortly',
                        hintStyle:
                            FlutterFlowTheme.of(context).labelMedium.override(
                                  fontFamily: FlutterFlowTheme.of(context)
                                      .labelMediumFamily,
                          ...
                          if ((_model.createDesigner?.succeeded ?? true)) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  getJsonField(
                                    (_model.createDesigner?.jsonBody ?? ''),
                                    r'''$.message''',
                                  ).toString(),
                                  style: TextStyle(
                                    color: FlutterFlowTheme.of(context)
