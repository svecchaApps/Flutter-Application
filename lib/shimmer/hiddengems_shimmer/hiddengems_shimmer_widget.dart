...
import 'hiddengems_shimmer_model.dart';
export 'hiddengems_shimmer_model.dart';

class HiddengemsShimmerWidget extends StatefulWidget {
  const HiddengemsShimmerWidget({super.key});

  @override
  State<HiddengemsShimmerWidget> createState() =>
      _HiddengemsShimmerWidgetState();
}

class _HiddengemsShimmerWidgetState extends State<HiddengemsShimmerWidget>
    with TickerProviderStateMixin {
  late HiddengemsShimmerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HiddengemsShimmerModel());
